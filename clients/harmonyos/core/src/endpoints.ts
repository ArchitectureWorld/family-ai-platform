import type { HttpMethod } from './requests.ts';

export type AuthenticationMode = 'public' | 'entry' | 'device';
...
export const MOBILE_ENDPOINTS = {
  pairingPreview: {
    method: 'POST',
    path: '/api/v1/mobile/pairing/preview',
    authentication: 'public'
  },
  pairingClaim: {
    method: 'POST',
    path: '/api/v1/mobile/pairing/claim',
    authentication: 'public'
  },
  portalContext: {
    method: 'GET',
...
} as const satisfies Record<string, MobileEndpoint>;
