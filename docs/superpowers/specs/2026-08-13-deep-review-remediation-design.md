...
**状态：** 历史整改设计基线；A1–A5 已合入，当前四层事实由 [`docs/development/2026-08-16-current-platform-truth.md`](../../development/2026-08-16-current-platform-truth.md) 接续

**日期：** 2026-08-13

**适用基线：** A1 合并提交 `29baa8f` 及其后续从最新 `main` 建立的独立任务分支

> 本文保留 2026-08-13 当时的发现和阶段设计，不把后续实现倒写成当时事实。任务状态以总计划为准，当前源码/自动化/Preview/正式运行物以 2026-08-16 事实矩阵为准。
